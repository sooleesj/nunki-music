...
declare class DatastoreRequest {
     ...
     */
    static prepareEntityObject_(obj: any): any;
    /**
     ...
     * });
     */
    allocateIds(key: any, options: any, callback: any): void;
    /**
     ...
     *   });
     */
    createReadStream(keys: any, options?: any): import("stream").Transform;
    /**
     ...
     * });
     */
    delete(keys: any, gaxOptions?: any, callback?: any): void;
    /**
     ...
     * });
     */
    get(keys: any, options?: any): Promise<EntityDataObj[]>;
    /**
     ...
     * @param {object} callback.apiResponse The full API response.
     */
    insert(entities: any, callback: any): void;
    /**
     ...
     *   });
     */
    runQueryStream(query: Query, options?: any): import("stream").Transform;
    /**
     ...
     * });
     */
    save(entities: any, gaxOptions?: any, callback?: any): void;
    /**
     ...
     * @param {object} callback.apiResponse The full API response.
     */
    update(entities: any, callback: any): void;
    /**
     ...
     * @param {object} callback.apiResponse The full API response.
     */
    upsert(entities: any, callback: any): void;
    /**
     ...
     * @private
     */
    request_(config: any, callback: any): void;
}
/**

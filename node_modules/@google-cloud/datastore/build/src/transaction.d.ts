...
declare class Transaction extends DatastoreRequest {
    ...
    readOnly: boolean;
    request: any;
    modifiedEntities_: any;
    skipCommit?: boolean;
    constructor(datastore: Datastore, options: any);
     ...
     * });
     */
    commit(gaxOptions?: any, callback?: any): void;
    /**
     ...
     * });
     */
    createQuery(namespace: string, kind?: string): import("./query").Query;
    /**
     ...
     * });
     */
    rollback(gaxOptions: any, callback?: any): void;
    /**
